...
export default function RaffleHeader({
  ...
  const progressPct = Math.round(
    ((soldCount + reservedCount) / raffle.total_tickets) * 100,
  )
  ...
  return (
    <div
      style={{
        background:
          "linear-gradient(160deg, #13102e 0%, #1a1640 60%, #0f0c28 100%)",
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <StatCard
              ...
              value={formatCurrency(raffle.ticket_price, "PEN")}
              accent="#f5a623"
              icon="💵"
            />
            <StatCard
          ...
          <div className="mt-4">
            ...
            >
              ...
              <span>
                {availableCount} / {raffle.total_tickets} disponibles
              </span>
            </div>
            <div
