...
create table if not exists public.tickets (
  ...
  referred_by    uuid references public.helpers(id),
...
-- ============================================================
-- 5. HELPERS — familiares y amigos que venden con su enlace
-- ============================================================
...
-- helpers: acceso completo público (el panel admin usa credenciales anónimas)
...
values (
  ...
  10, 1000, date '2026-08-30' + time '20:00', 'active',
  'iPhone 15 · S/600 · S/300 · Premio Sorpresa'
)
on conflict (slug) do nothing;

-- Generar los 1000 números de la rifa inicial
